= Phương pháp phát hiện dựa trên các đặc trưng bất biến
...
== Sự kết hợp giữa đặc trưng hình thái và ngữ nghĩa (AIDE)
...
== Cơ chế thích nghi tại thời điểm kiểm thử (Test-Time Adaptation - TTA)
